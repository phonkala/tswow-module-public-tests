...
-- tswow-module-custom-ui BEGIN --
PowerBarColor["LUNAR_POWER"] = { r = 0.54, g = 0.42, b = 0.90 };
-- tswow-module-custom-ui END --
-- vehicle colors
...
-- tswow-module-custom-ui BEGIN --
PowerBarColor[7] = PowerBarColor["LUNAR_POWER"];
-- tswow-module-custom-ui END --
...
function UnitFrameManaBar_UpdateType (manaBar)
	...
	if ( info ) then
		if ( not manaBar.lockColor ) then
			...
			-- tswow-module-custom-ui BEGIN --
			local _,class = UnitClass("player");
			if ( class == "ARCHDRUID" ) then
				info = PowerBarColor["LUNAR_POWER"];
				manaBar:SetStatusBarColor(info.r, info.g, info.b);
			end
			-- tswow-module-custom-ui END --
